        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Modifier Mr.{{ $user->first_name }} {{ $user->last_name }} </h1>

                </div>
                <!-- /.container-fluid -->
                <form action="{{ route('update_per', ['id' => auth()->id()]) }} " method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="title">
                    ...
                    <div class="title">
                      ...
                      <p><i class="fas fa-exclamation-triangle attention-icon"></i>Attention votre donnes seront modifie depuis la base de donnes</p>

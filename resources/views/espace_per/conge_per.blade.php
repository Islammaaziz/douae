...
<body id="page-top" class="dark-mode">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('formation_per') }}" data-toggle="collapse" data-target="#collapsePages"
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Espace congé</h1>
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-circle"></i> Vous disposez de 18 jours de congé. Si vous dépassez ce nombre, vous pourriez avoir des pénalités.
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <form action="{{route('store_conge')}}" method="POST">
                                    @csrf
                                    ...
                                    <button type="submit" class="btn btn-primary form-control">Demander congé</button>
                                </form>
                            </div>
                        </div>
                    </div>

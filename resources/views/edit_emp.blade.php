        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Modifier Employe {{$employe->first_name}}  {{$employe->last_name}}</h1>
...
@if (session('updatedEmployee'))
    <div class="alert alert-info">
        Employé mis à jour :
        <ul>
            <li>Nom : {{ session('updatedEmployee')->first_name }}</li>
            <li>Prénom : {{ session('updatedEmployee')->last_name }}</li>
            <!-- Ajoutez d'autres informations à afficher -->
        </ul>
    </div>
@endif
        
            <form action="{{ route('update_emp', $employe->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="title">
